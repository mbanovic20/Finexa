...
namespace Finexa.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PlatformSupportedCurrencies",
                columns: table => new
                {
                    SupportedCurrenciesId = table.Column<int>(type: "int", nullable: false),
                    SupportedPlatformsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlatformSupportedCurrencies", x => new { x.SupportedCurrenciesId, x.SupportedPlatformsId });
                    table.ForeignKey(
                        name: "FK_PlatformSupportedCurrencies_Currencies_SupportedCurrenciesId",
                        column: x => x.SupportedCurrenciesId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlatformSupportedCurrencies_Platforms_SupportedPlatformsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cards_Platforms_PlatformId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    WalletType = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    WalletAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PlatformId = table.Column<int>(type: "int", nullable: true),
                    DigitalWallet_CurrencyId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wallets_Currencies_DigitalWallet_CurrencyId",
                        column: x => x.DigitalWallet_CurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Wallets_Platforms_PlatformId",
                        column: x => x.PlatformId,
                        principalTable: "Platforms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Days_DayId",
                        column: x => x.DayId,
                        principalTable: "Days",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlatformSupportedCurrencies_SupportedPlatformsId",
                table: "PlatformSupportedCurrencies",
                column: "SupportedPlatformsId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_DayId",
                table: "Transactions",
                column: "DayId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wallets_DigitalWallet_CurrencyId",
                table: "Wallets",
                column: "DigitalWallet_CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_Wallets_PlatformId",
                table: "Wallets",
                column: "PlatformId");
